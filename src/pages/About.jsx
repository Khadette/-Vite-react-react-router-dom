...
// Reusable SkillBar component — defined in the same file for simplicity
// For larger projects, extract this to src/components/SkillBar.jsx
  ...
  return (
    <div className="mb-4">
      ...
      <div className="w-full bg-gray-200 rounded-full h-2">
        {/* Fill — width set dynamically via inline style */}
        <div
...
function About() {
  return (
    <div>
      ...
      {/* ═══ PAGE HERO ═══════════════════════════════════════════════ */}
      <section className="bg-linear-to-r from-blue-900 to-blue-700 py-20 px-4">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Render a SkillBar for each skill */}
            ...
            {timeline.map((item, index) => (
              <div key={index} className="flex gap-6 mb-8 relative">
                ...
                <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center
                                justify-center text-white font-bold text-sm shrink-0 z-10">
                  {item.year}
                </div>
                {/* Card */}
