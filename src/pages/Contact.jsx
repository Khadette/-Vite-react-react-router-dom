function Contact() {
  // Form submission handler — no state needed, using FormData API
  function handleSubmit(event) {
    ...
    // TODO: Send data to your backend API or EmailJS
                  ...
                  {['GitHub', 'LinkedIn', 'Twitter'].map(s => (
                    <a
                      ...
                      className="bg-white border border-gray-200 hover:border-blue-500
                                  hover:text-blue-600 text-gray-600 px-4 py-2 rounded-lg
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold
                              py-3 rounded-lg transition-colors duration-200 text-sm"
                >
                  Send Message →
                </button>
              </form>
